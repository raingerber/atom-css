...
Highlights.prototype.populate = function populate(startIndex) {
  ...
  // var i = _.isFinite(startIndex * 1) ? startIndex * 1 : 0; // make sure it's within bounds
  var i = startIndex * 1;
  console.log(i);
  this.setIndex(i);
  this.toggleFocus(false);
  ...
  console.log('in populat', this.highlights);
  this.toggleFocus(true);
  return this;
};
...
function createHighlight(editor, fSel) {
  ...
  return new Highlight(editor, fSel.range, fSel.text);
}
