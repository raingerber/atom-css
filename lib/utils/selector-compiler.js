...
function getCompiledSelector(fileSearch, emitter, selection) {
  ...
  if (matches) {
    currentHighlights = new Highlights(selection.editor, matches).populate(null); // null means don't focus on a particular highlight
    el = atom.views.getView(selection.editor);
