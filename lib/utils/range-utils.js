...
function normalizeTextRange(bufferLine, css, path) {
  ...
  if (arrayOfLines.length > 15) {
    window.a = arrayOfLines;
  }
...
// function normalizeTextRang(bufferLine, css) {
//   var line = Point.sourceLineToAtomLine(bufferLine);
...
function normalize(bufferLine, css) {
  // debugger;
  var line = Point.sourceLineToAtomLine(bufferLine);
  // console.log(bufferLine, line);
  // console.error(bufferLine, line);
  var arrayOfLines = css.match(/[^\r\n]+/g);
  // console.log(line);
  // console.log(arrayOfLines);
  var text = arrayOfLines[line];
  // console.log(text);
  // window.x = arrayOfLines;
  // console.log(text, '||||', arrayOfLines[line + 1]);
