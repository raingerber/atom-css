...
var app = {
  activate: function activate() {
    ...
    files = new FileSearch(paths); // put in a function so you can change the paths dynamically
...
function addTextEditorObserver(view, editor) {
  addSelectionListener(editor, function onSelectorUpdate(compiledSelector) {
