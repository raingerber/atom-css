...
View._menuLinks.querySelector('.show-with-find-anchor').addEventListener('click', toggleShowWithFind);

function toggleShowWithFind() {
  showTogetherWithFindPanel = !showTogetherWithFindPanel;
  console.log(showTogetherWithFindPanel);
}
